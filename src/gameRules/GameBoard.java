...
public class GameBoard {
    ...
    public void placeFirstTileAndUpdateValidPlacementList() {
    ...
    public void setTileAtPosition(int colPos, int rowPos, Tile tileToBePlaced) {
        try {
    ...
    public boolean hexesToPlaceTileOnAreAlreadyOccupied(int colPos, int rowPos, Tile tileToBePlaced) {
    ...
    public void nukeTiles(int colPos, int rowPos, Tile tileToBePlaced) {
    ...
    public boolean nukeAtPositionIsValid(int colPos, int rowPos, Tile tileToBePlaced) {
    ...
    public boolean isValidSettlementLocation(int colPos, int rowPos) {
        try {
    ...
    public boolean isValidTotoroPlacement(int colPos, int rowPos, int settlementID, Player playerBuilding) {
        try {
    ...
    public boolean checkIfValidTigerPlacement(int colPos, int rowPos, int settlementID, Player playerBuilding) {
        try {
            if(gameBoardPositionArray[colPos][rowPos].getTerrainType() == terrainTypes.VOLCANO) {
                return false;
            }
    ...
    public void expandSettlement(int colPos, int rowPos, terrainTypes expansionType, Player player) {
    ...
    public int calculateVillagersForExpansion(int colPos, int rowPos, terrainTypes expansionType, Player player) {
        try {
            if(isBuiltOn(colPos, rowPos)) {
                if(gameBoardHexIsOwnedByPlayer(player.getPlayerID(), colPos, rowPos)) {
                    int returnVal = 0;
    ...
    public int calculateScoreForExpansion(int colPos, int rowPos, terrainTypes expansionType, Player player) {
        try {
            if(isBuiltOn(colPos, rowPos)) {
                if(gameBoardHexIsOwnedByPlayer(player.getPlayerID(), colPos, rowPos)) {
                    int returnVal = 0;
    ...
    public Hex[][] getGameBoardPositionArray() {
        return gameBoardPositionArray;
    }

    public int[][] getValidPlacementArray() {
        return validPlacementArray;
    }

    public int getGameBoardPositionSettlementID(Pair currentCoordinates) {
    ...
    public void setGameBoardSettlementListPlayerID(int settlementID, int playerID) {
        this.gameBoardSettlementList[settlementID][0] = playerID;
    }

    public int getGameBoardTileID() {
        return gameBoardTileID;
    }

    public int getGameBoardHexID() {
    ...
    public void assignSizeToGameBoardSettlementList(int settlementID, int settlementSize) {
    ...
    public int getGameBoardSettlementListOwner(int settlementID) {
        return this.gameBoardSettlementList[settlementID][0];
    }

    public int getGameBoardSettlementListSettlementSize(int settlementID) {
        return this.gameBoardSettlementList[settlementID][1];
    }

    public int getGameBoardSettlementListTotoroCount(int settlementID) {
        return this.gameBoardSettlementList[settlementID][2];
    }

    public int getGameBoardSettlementListTigerCount(int settlementID) {
